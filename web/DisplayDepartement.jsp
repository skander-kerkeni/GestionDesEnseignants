...
<html>
    ...
    <body >
        ...
        <div>
            <a href="./AddDepartement.jsp" class="btn btn-primary">Ajouter
                ...
                <thead>
                    ...
                    <%
                        if (request.getAttribute("resultat") != null) {
                            List<Departement> rs = (List<Departement>) request.getAttribute("resultat");
                            for (Departement ee : rs) {
                    %>

                    <tr>
                        <td><%=ee. getLibelle_departement()%></td>
                        <td><%=ee. getChef()%>
                       </td>
                        
                        <td> <a href="./DepartementController?action=editchef&id=<%=ee.getId_departement()%>" class="btn btn-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
</svg>
                                
                            </a> 
                            <a href="./DepartementController?action=edit&id=<%=ee.getId_departement()%>" class="btn btn-primary">
                            ...
                            <a href="./DepartementController?action=delete&id=<%=ee.getId_departement()%>" class="btn btn-outline-danger">
