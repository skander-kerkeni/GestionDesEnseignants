...
<html>
    ...
    <body>
        ...
        <div>
            <a href="./addNiveau.jsp" class="btn btn-primary">Ajouter
                ...
                <thead>
                    ...
                    <%
                        if (request.getAttribute("resultat") != null) {
                            List<Niveau> rs = (List<Niveau>) request.getAttribute("resultat");
                            for (Niveau ee : rs) {
                    %>
                    ...
                    <tr>
                        ...
                        <td><a href="./NiveauController1?action=edit&id=<%=ee.getId_niveau()%>" class="btn btn-primary">
                            ...
                            <a href="./NiveauController1?action=delete&id=<%=ee.getId_niveau()%>" class="btn btn-outline-danger">
