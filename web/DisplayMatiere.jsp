...
<html>
    ...
    <body>
        ...
        <div>
            <a href="./MatiereController?action=display"  class="btn btn-primary">Ajouter
        ...
        <div class="panel-body">
            <table id="tbl-student" class="table table-responsive table-bordered" cellpadding ="0" width="100%">
                <thead>
                    <tr>
                        <th>Libelle</th>
                        <th>Charge_horaire_tp</th>
                        <th>Charge_horaire_td</th>
                        <th>Charge_horaire_cours</th>
                        <th>Departement</th>
                        <th>Niveau</th>
                        <th>Enseignant</th>
                    ...
                    <%
                        if (request.getAttribute("resultat") != null) {
                            List<Matiere> rs = (List<Matiere>) request.getAttribute("resultat");
                            for (Matiere ee : rs) {
                    %>
                    ...
                    <tr>
                        ...
                        <td><%=ee.getTd()%></td>
                        <td><%=ee.getCours()%></td>
                        <th><%=ee.getDepartement()%></th>
                        <th><%=ee.getNiveau()%></th>
                        <th><%=ee.getEnseignant()%></th>
                        
                        <td><a href="./MatiereController?action=edit&id=<%=ee.getId_matiere()%>" class="btn btn-primary">
                            ...
                            <a href="./MatiereController?action=delete&id=<%=ee.getId_matiere()%>" class="btn btn-outline-danger">
