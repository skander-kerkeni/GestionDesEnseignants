    ...
    <body>
        ...
        <%
            if (request.getAttribute("resultat") != null) {
                Departement departement = (Departement) (request.getAttribute("resultat"));
            ...
            <div class="col-sm-4">
                <form method="post" action="./DepartementController">
                    ...
                    <div alight="left">
                        ...
                        <input type="text" class="form-control" value="<%=departement.getLibelle_departement()%>"  name="libelle" id="libelle" required >
                    </div>
                    <div alight="left">
