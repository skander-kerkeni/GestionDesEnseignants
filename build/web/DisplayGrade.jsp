...
<html>
    ...
    <body>
        ...
        <div>
            <a href="./AddGrade.jsp" class="btn btn-primary">Ajouter
        ...
        <div class="panel-body">
            <table id="tbl-student" class="table table-responsive table-bordered" cellpadding ="0" width="100%">
                <thead>
                    ...
                    <tr>
                        <td><%=ee.getLibelle()%></td>
                        <td><%=ee.getPrix_H_cours()%></td>
                        <td><%=ee.getPrix_H_td()%></td>
                        <td><%=ee.getPrix_H_tp()%></td>
                        
                        <td><a href="./GradeController?action=edit&id=<%=ee.getId_grade()%>" class="btn btn-primary">
                            ...
                            <a href="./GradeController?action=delete&id=<%=ee.getId_grade()%>" class="btn btn-outline-danger">
