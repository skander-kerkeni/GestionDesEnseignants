    ...
    <body>
        ...
        <%
            if (request.getAttribute("resultat") != null) {
                Niveau niveau = (Niveau) (request.getAttribute("resultat"));
        ...
        <div class="row">
            <div class="col-sm-4">
                <form method="post" action="./NiveauController1">
                    ...
                    <input type="hidden" name="id" value="<%=niveau.getId_niveau()%>"/>
                    <div alight="left">
                        <label class="form-label">Libelle</label>
                        <input type="text" class="form-control" value="<%=niveau.getLibelle()%>"  name="libelle" id="libelle" required >
                    </div>
                    <div alight="left">
