...
<html>
    ...
    <body>
        ...
        <form method="post" action="./MatiereController">
            ...
            <div alight="left">
                <label class="form-label"><h3>charge :</h3></label><br>
                <label class="form-label">Heure de cours :</label>
                <input type="text" class="form-control" placeholder="Heure de cours" name="cours" id="cours" required >
            </div>
            <div alight="left">
                <label class="form-label">Heure de TP :</label>
                <input type="text" class="form-control" placeholder="Heure de TP" name="td" id="td" required >
            </div>
            <div alight="left">
                <label class="form-label">Heure de TD :</label>
                <input type="text" class="form-control" placeholder="Heure de TD " name="tp" id="tp" required >
            </div>
               <div alight="left">
